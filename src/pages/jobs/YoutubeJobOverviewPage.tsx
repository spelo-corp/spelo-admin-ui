...
const YoutubeJobOverviewPage: React.FC = () => {
    const { job, sentences, readOnly, reloadJob } = useOutletContext<YoutubeJobOutletContext>();
    ...
    const jobMeta = useMemo(
        () => [
            ...
            { label: "YouTube Video", value: job.youtubeVideoId || "—" },
            { label: "Start Time", value: job.startTime != null ? `${job.startTime}s` : "—" },
            { label: "End Time", value: job.endTime != null ? `${job.endTime}s` : "—" },
            ...
            <div className="space-y-3 lg:space-y-4">
                ...
                <div className="bg-white rounded-card shadow-card border border-slate-100 p-4 lg:p-5 space-y-3">
                    <div className="flex items-center justify-between">
                        <div>
                            <h2 className="text-lg font-semibold text-slate-900">YouTube Video</h2>
                            <p className="text-xs text-slate-500">Preview the source video.</p>
                        </div>
                    </div>
                    ...
                    {job.youtubeVideoId ? (
                        ...
                        <div className="text-sm text-slate-600">
                            No YouTube video ID available for this job.
                        </div>
                    )}
                </div>
...
export default YoutubeJobOverviewPage;
