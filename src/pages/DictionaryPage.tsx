        ...
        <div className="relative min-h-screen overflow-hidden px-8 py-6">
            <div className="relative z-10 space-y-8">
                <PageHeader
                    ...
                    title="Dictionary"
                    description="Curated, polished words with IPA, meaning, and examples."
                    actions={
                        <>
                            <Btn.HeroSecondary onClick={openAutoCreateSection}>
                ...
                <div className="grid gap-4 md:grid-cols-[220px,1fr] lg:grid-cols-[260px,1fr] md:gap-6">
                    ...
                    <aside className="hidden flex-col gap-3 lg:flex sticky top-6">
                        <div className="overflow-hidden rounded-card border border-slate-100 bg-white p-3 shadow-card">
                    ...
                    <main className="space-y-5 md:space-y-6">
                        ...
                        <div className="space-y-10">
                            {loading ? (
                                ...
                                <div className="rounded-card border border-dashed border-slate-200 bg-white p-10 text-center shadow-card">
                                    ...
                                    <p className="mt-1 text-sm text-slate-500">
                                        Try a different search, or add a new word to kick things
                                        off.
                                    </p>
                                            ...
                                            <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                                                {list.map((w) => {
                                                    ...
                                                    return (
                                                        <article
                                                            key={w.id}
                                                            className="group relative overflow-hidden rounded-2xl border border-slate-100 bg-white p-5 shadow-card transition duration-200 hover:-translate-y-0.5 hover:shadow-xl"
                                                        >
